package Sah::Schema::perl::comparer::modname_with_optional_args;
...
our $schema = [str => {
    summary => 'Perl Comparer::* module name without the prefix (e.g. Foo::bar) with optional arguments (e.g. Foo::baz,qux,quux)',
    description => <<'_',
